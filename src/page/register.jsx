function Register() {
  return (
    <div className="text-black dark:text-white flex justify-center items-center w-full max-w-full p-10 mx-auto m-10 md:flex-0 shrink-0">
      <div className="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
        <div className="p-6 mb-0 text-center bg-white border-b-0 rounded-t-2xl">
          <h5>Regístrate con</h5>
        </div>
        <div className="flex items-center justify-center flex-wrap px-3 -mx-3 sm:px-6 xl:px-12">
        ...
        <div className="flex-auto p-6">
          <form role="form text-left">
            ...
            <p className="mt-4 mb-0 leading-normal text-sm">
              ...
              <a className="font-bold text-slate-700" href="../sign-in">
                Iniciar sesión
              </a>
            </p>
          </form>
