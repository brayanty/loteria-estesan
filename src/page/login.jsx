function Register() {
  return (
    <div className="bg-white dark:bg-black text-black dark:text-white flex justify-center items-center w-full max-w-full p-10 mx-auto m-10 md:flex-0 shrink-0">
